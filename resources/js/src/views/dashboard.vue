<template>
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="javascript:;" class="text-primary hover:underline">Apps</a>
            </li>
                    ...
                    <div class="p-5">
                        ...
                        <div class="mb-5 space-y-1">
                            <div class="flex items-center justify-between">
                                <p class="text-[#515365] font-semibold">Rastreo</p>
                                <p class="text-base"><span>$</span> <span class="font-semibold">Demo</span></p>
                            </div>
                            <div class="flex items-center justify-between">
                                <p class="text-[#515365] font-semibold">Mantenimiento</p>
                                <p class="text-base"><span>$</span> <span class="font-semibold">Demo</span></p>
                            </div>
                            <div class="flex items-center justify-between">
                                <p class="text-[#515365] font-semibold">Combustible</p>
                                <p class="text-base"><span>$</span> <span class="font-semibold">Demo</span></p>
                            </div>
                        </div>
                        <div class="text-center px-2 flex justify-around">
                            <button type="button" class="btn btn-secondary ltr:mr-2 rtl:ml-2">Ver Detalles</button>
