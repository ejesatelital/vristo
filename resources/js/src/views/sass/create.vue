                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col sm:flex-row">
                                            ...
                                            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                ...
                                                <div>
                                                    <label for="web">Empresa Principal</label>
...
const selectedOption = ref({label: 'Empresa Principal', value: 0});
const options = ref(companyStore.companyOptions);
const displayOptions = computed(() => [
    {label: 'Empresa Principal', value: 0},
    ...options.value
]);
...
const handleSelection = (option) => {
    if (option.value !== 0) {
        companyData.value.parent_id=null
    }else {
        companyData.value.parent_id=option.value
    }
...
const createCompany = async () => {
    ...
    try {
        const response = await api.post(`sass/v1/companies`, companyData.value);
