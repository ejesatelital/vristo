    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <router-link :to="companyData.parent_id?{name:'companies'}:{name:'companies-show', params: {id: route.params.id}}"
            ...
            <TabGroup>
                        ...
                        <a href="javascript:;"
                           ...
                           :class="{ '!border-primary text-primary': selected }">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                ...
                                <circle cx="2" cy="2" r="2" transform="matrix(1 0 0 -1 14 16)" stroke="#1C274C"
                                        stroke-width="1.5"/>
                ...
                <TabPanels>
                    <form @submit.prevent="editCompany">
                                            ...
                                            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                ...
                                                <div>
                                                    ...
                                                    <input id="identification" type="text"
                                                           ...
                                                           class="form-input" v-model="companyData.identification"
                                                           required/>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <input id="web" type="text"
                                                           placeholder="https://www.ejesatelital.com/"
                                                           class="form-input"
                        ...
                        <TabPanel>
                            <users-component :company-data="companyData" :update-users="companyData.users"/>
                        </TabPanel>
                        <TabPanel>
                            <div>
...
watch(companySelected, (value, oldValue, onCleanup) => {
    companyData.value.parent_id = value.value;
});
...
const getData = async () => {
    try {
        ...
        if (data.parent_id) {
            companySelected.value = {label: data.parent.name, value: data.parent.id}
        }
...
onMounted(async () => {
    await getData();
    const conpanies = companyStore.companies.filter((x) => !x.parent_id)
    companies.value = conpanies.map((x) => {
