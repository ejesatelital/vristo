                        ...
                        <div class="space-y-5">
                            <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <input id="password_tracking" :type="showPasswords.password_tracking ? 'text' : 'password'"
                            ...
                            <button type="button" class="btn btn-primary mb-5" @click="getUserApiToken">Generate Token</button>
                            <div class="mb-5">
                                <label for="user_api_hash">User API Hash</label>
                                <div class="flex">
                                    <input id="user_api_hash" :type="showPasswords.user_api_hash ? 'text' : 'password'"
                                        placeholder="Enter Password"
                            ...
                            <div class="mb-5 grid grid-cols-1 sm:grid-cols-2">
                                ...
                                <div class="md:mr-1 mb-3" v-if="companyData.settings.sync_tracking">
                                    ...
                                    <input id="sync_time" type="number" min="0" placeholder="Enter time in minutes" class="form-input" v-model="companyData.settings.sync_time" />
                                </div>

                                <div class="md:ml-1 mb-3" v-if="companyData.settings.sync_tracking">
                                    <label for="user_api_hash">Última sincronización</label>
                                    <div class="relative">
                                        <input id="last_sync" class="form-input" v-model="companyData.settings.last_sync" readonly disabled/>

                                        <button type="button" v-tippy:sync class="btn btn-outline-info btn-sm align-items-center absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500" @click="syncData()">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <label class="inline-flex">
                                        <input type="checkbox" class="form-checkbox text-success" v-model="companyData.settings.sync_driver"/>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input id="whatsapp_version" type="text"
                                    placeholder="WhatsApp API Version" class="form-input" v-model="companyData.settings.whatsapp_version"/>
                            </div>
                        </div>
                    </div>
                </vue-collapsible>
