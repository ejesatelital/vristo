                            ...
                            <div class="space-y-5">
                                <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input id="user_tracking" type="text" placeholder="Enter User"
                                               class="form-input" v-model="companyData.settings.user_tracking"/>
                                    </div>
                                    <div>
                                        <label for="password_tracking">Pass</label>
                                        <div class="flex">
                                            <input id="password_tracking"
                                                   :type="showPasswords.password_tracking ? 'text' : 'password'"
                                                   placeholder="Enter Password"
                                                   class="form-input ltr:rounded-r-none rtl:rounded-l-none"
                                                   v-model="companyData.settings.password_tracking"/>
                                            <div
                                                ...
                                                <label
                                                    ...
                                                    <input type="checkbox"
                                                           v-model="showPasswords.password_tracking"
                                ...
                                <button type="button" class="btn btn-primary mb-5" @click="getUserApiToken">Generate
                                    Token
                                </button>
                                <div class="mb-5">
                                    <label for="user_api_hash">User API Hash</label>
                                    <div class="flex">
                                        <input id="user_api_hash"
                                               :type="showPasswords.user_api_hash ? 'text' : 'password'"
                                               placeholder="Enter Password"
                                               class="form-input ltr:rounded-r-none rtl:rounded-l-none"
                                               v-model="companyData.settings.user_api_hash"/>
                                        <div
                                            class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                            <label
                                                class="w-7 h-4 relative cursor-pointer mb-0">
                                                <input type="checkbox"
                                                       v-model="showPasswords.user_api_hash"
                                                       class="peer absolute w-full h-full opacity-0 z-10 focus:ring-0 focus:outline-none cursor-pointer"
                                ...
                                <div class="mb-5 grid grid-cols-1 sm:grid-cols-2">
                                    <div class="md:col-span-2 mb-3">
                                        ...
                                        <label class="inline-flex">
                                            <input type="checkbox" class="form-checkbox text-success"
                                                   v-model="companyData.settings.sync_tracking"/>
                                            <span>Sincronizar Dispositivos</span>
                                        </label>
                                    </div>

                                    <div class="md:mr-1 mb-3" v-if="companyData.settings.sync_tracking">
                                        <label for="sync_time">Tiempo de sincronización en minutos</label>
                                        <input id="sync_time" type="number" min="0" placeholder="Enter time in minutes"
                                               class="form-input" v-model="companyData.settings.sync_time"/>
                                    </div>

                                    <div class="md:ml-1 mb-3" v-if="companyData.settings.sync_tracking">
                                        <label for="user_api_hash">Última sincronización</label>
                                        <div class="relative">
                                            <input id="last_sync" class="form-input"
                                                   v-model="companyData.settings.last_sync" readonly disabled/>

                                            <button type="button" v-tippy:sync
                                                    class="btn btn-outline-info btn-sm align-items-center absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500"
                                                    @click="syncData()">
                                            ...
                                            <tippy target="sync">Sincronizar</tippy>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <label class="inline-flex">
                                            <input type="checkbox" class="form-checkbox text-success"
                                                   v-model="companyData.settings.sync_driver"/>
                                            <span>Sincronizar Conductores</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-5">
                                <div
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input id="email_host" type="text" placeholder="Enter Server Email"
                                               class="form-input" v-model="companyData.settings.email_host"/>
                                    </div>
                                    <div>
                                        <label for="email_port">Port</label>
                                        <input id="email_port" type="number" placeholder="Enter Port Email"
                                               class="form-input" v-model="companyData.settings.email_port"/>
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input id="email_username" type="email" placeholder="Enter Email"
                                               class="form-input" v-model="companyData.settings.email_username"/>
                                    </div>
                                    <div>
                                        ...
                                        <div class="flex">
                                            <input id="email_password"
                                                   ...
                                                   class="form-input ltr:rounded-r-none rtl:rounded-l-none"
                                                   v-model="companyData.settings.email_password"/>
                                            <div
                                                class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                                <label
                                                    class="w-7 h-4 relative cursor-pointer mb-0">
                                                    <input type="checkbox"
                                                           v-model="showPasswords.email_password"
                                                           class="peer absolute w-full h-full opacity-0 z-10 focus:ring-0 focus:outline-none cursor-pointer"
                                                           id="email_password_check"/>
                                                    <span
                                                        class="rounded-full border border-[#adb5bd] bg-white peer-checked:bg-primary peer-checked:border-primary dark:bg-dark block h-full before:absolute ltr:before:left-0.5 rtl:before:right-0.5 ltr:peer-checked:before:left-3.5 rtl:peer-checked:before:right-3.5 peer-checked:before:bg-white before:bg-[#adb5bd] dark:before:bg-white-dark before:bottom-[2px] before:w-3 before:h-3 before:rounded-full before:transition-all before:duration-300"></span>
                                                </label>
                                            </div>
                                ...
                                <div>
                                    ...
                                    <input id="email_from_address" type="email" placeholder="Sender's Email"
                                           class="form-input" v-model="companyData.settings.email_from_address"/>
                                </div>
                                <div>
                                    <label for="email_from_name">Sender Name</label>
                                    <input id="email_from_name" type="text" placeholder="Sender Name" class="form-input"
                                           v-model="companyData.settings.email_from_name"/>
                                </div>
                                <div>
                                    <label for="email_subject">Affair</label>
                                    <input id="email_subject" type="text" placeholder="Affair" class="form-input"
                                           v-model="companyData.settings.email_subject"/>
                                </div>
                                <div>
                                    <label for="email_message">Comment</label>
                                    <textarea rows="3" wrap="soft" class="form-textarea" x-model="email_message"
                                              id="email_message"
                                              v-model="companyData.settings.email_message"></textarea>
                                </div>
                        ...
                        <div
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="flex">
                                        <input id="whatsapp_token"
                                               ...
                                               class="form-input ltr:rounded-r-none rtl:rounded-l-none"
                                               v-model="companyData.settings.whatsapp_token"/>
                                        <div
                                            class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                            <label
                                                class="w-7 h-4 relative cursor-pointer mb-0">
                                                <input type="checkbox"
                                                       v-model="showPasswords.whatsapp_token"
                                                       class="peer absolute w-full h-full opacity-0 z-10 focus:ring-0 focus:outline-none cursor-pointer"
                                                       id="whatsapp_token_check"/>
                                                <span
                                                    class="rounded-full border border-[#adb5bd] bg-white peer-checked:bg-primary peer-checked:border-primary dark:bg-dark block h-full before:absolute ltr:before:left-0.5 rtl:before:right-0.5 ltr:peer-checked:before:left-3.5 rtl:peer-checked:before:right-3.5 peer-checked:before:bg-white before:bg-[#adb5bd] dark:before:bg-white-dark before:bottom-[2px] before:w-3 before:h-3 before:rounded-full before:transition-all before:duration-300"></span>
                                            </label>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input id="whatsapp_sender" type="text" placeholder="WhatsApp Send Number"
                                           class="form-input" v-model="companyData.settings.whatsapp_sender"/>
                                </div>
                                <div>
                                    <label for="whatsapp_message">Message</label>
                                    <textarea rows="3" wrap="soft" class="form-textarea" x-model="Message"
                                              id="whatsapp_message"
                                              v-model="companyData.settings.whatsapp_message"></textarea>
                                </div>
                                <div>
                                    <label for="whatsapp_template">WhatsApp Template</label>
                                    <input id="whatsapp_template" type="text" placeholder="WhatsApp Template"
                                           class="form-input" v-model="companyData.settings.whatsapp_template"/>
                                </div>
                                <div>
                                    <label for="whatsapp_version">WhatsApp API
                                        Version</label>
                                    <input id="whatsapp_version" type="text"
                                           placeholder="WhatsApp API Version" class="form-input"
                                           v-model="companyData.settings.whatsapp_version"/>
                                </div>
                            </div>
                        </div>
                    </vue-collapsible>
                </div>
                <!-- Configuration API Sysfo -->
                <div class="border border-[#d3d3d3] dark:border-[#1b2e4b] rounded">
                    <button type="button"
                            class="p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b]"
                            :class="{ '!text-primary': accordians === 4 }"
                            @click="accordians === 4 ? (accordians = null) : (accordians = 4)">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                             xmlns="http://www.w3.org/2000/svg"
                             class="w-5 h-5 ltr:mr-2 rtl:ml-2 text-primary shrink-0">
                            <path opacity="0.5"
                    ...
                    <vue-collapsible :isOpen="accordians === 4">
                        <div
                            ...
                            <div class="space-y-5">
                                <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="md:col-span-2 mb-3">
                                        <label for="user_api_devices">Activar Api</label>
                                        <label class="inline-flex">
                                            <input type="checkbox" class="form-checkbox text-success"
                                                   v-model="companyData.settings.sysfo_sync"/>
                                            <span>Activar Conexión Api</span>
                                        </label>
                                    </div>
                                    <div>
                                        <label for="user_tracking">Key</label>
                                        <input id="user_tracking" type="text" placeholder="Enter User"
                                               class="form-input" v-model="companyData.settings.sysfo_key"/>
                                    </div>
                                    <div>
                                        <label for="password_tracking">Secret</label>
                                        <div class="flex">
                                            <input id="password_tracking"
                                                   :type="showPasswords.sysfo_secret ? 'text' : 'password'"
                                                   placeholder="Enter Password"
                                                   class="form-input ltr:rounded-r-none rtl:rounded-l-none"
                                                   v-model="companyData.settings.sysfo_secret"/>
                                            <div
                                                class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                                <label
                                                    class="w-7 h-4 relative cursor-pointer mb-0">
                                                    <input type="checkbox"
                                                           v-model="showPasswords.sysfo_secret"
                                                           class="peer absolute w-full h-full opacity-0 z-10 focus:ring-0 focus:outline-none cursor-pointer"
                                                           id="password_tracking_check"/>
                                                    <span
                                                        class="rounded-full border border-[#adb5bd] bg-white peer-checked:bg-primary peer-checked:border-primary dark:bg-dark block h-full before:absolute ltr:before:left-0.5 rtl:before:right-0.5 ltr:peer-checked:before:left-3.5 rtl:peer-checked:before:right-3.5 peer-checked:before:bg-white before:bg-[#adb5bd] dark:before:bg-white-dark before:bottom-[2px] before:w-3 before:h-3 before:rounded-full before:transition-all before:duration-300"></span>
...
const getUserApiToken = async () => {
    const getUserApiTokenData = {
        email: props.companyData.settings.user_tracking,
        password: props.companyData.settings.password_tracking
    }
    try {
        const response = await api.post(`ejetrack/auth/login`, getUserApiTokenData);
        props.companyData.settings.user_api_hash = response.data.data.user_api_hash
        Swal.fire({
            icon: 'success',
            title: 'Success',
            text: 'Updating...',
