        ...
        <div class="pt-5">
            <TabGroup>
                ...
                <TabPanels>
                                            ...
                                            <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                ...
                                                <div>
                                                    ...
                                                    <input id="email" type="email" placeholder="info@ejesatelital.com"
                                                        class="form-input" v-model="companyData.email" required />
                                                </div>
                                                <div>
                                                    <label for="web">Website</label>
                                                    <input id="web" type="text"
                                                        placeholder="https://www.ejesatelital.com/" class="form-input"
                                                        v-model="companyData.web" />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <TabPanel>
                        <div>
                            <form @submit.prevent="editApiCompany">
                                <!-- Apis Configurations -->
                                                        ...
                                                        <div class="space-y-5">
                                                            <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                <div>
                                                                    ...
                                                                    <input id="user_tracking" type="text" placeholder="Enter User" class="form-input" v-model="apiData.settings.user_tracking" />
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <div class="flex">
                                                                        <input id="password_tracking" type="password"
                                                                            ...
                                                                            class="form-input ltr:rounded-r-none rtl:rounded-l-none" v-model="apiData.settings.password_tracking"/>
                                                                        <div
                                                            ...
                                                            <div class="mb-5">
                                                                ...
                                                                <div class="flex">
                                                                    <input id="user_api_hash" type="password"
                                                                        placeholder="Enter Password"
                                                                        class="form-input ltr:rounded-r-none rtl:rounded-l-none" v-model="apiData.settings.user_api_hash"/>
                                                                    <div
                                                                        class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                                                        <label
                                                                            class="w-7 h-4 relative cursor-pointer mb-0">
                                                        ...
                                                        <div class="space-y-5">
                                                            <div
                                                                ...
                                                                <div class="md:col-span-2">
                                                                    ...
                                                                    <input id="email_host" type="text" placeholder="Enter Server Email" class="form-input" v-model="apiData.settings.email_host" />
                                                                </div>
                                                                <div>
                                                                    <label for="email_port">Port</label>
                                                                    <input id="email_port" type="number" placeholder="Enter Port Email" class="form-input" v-model="apiData.settings.email_port"/>
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                <div>
                                                                    ...
                                                                    <input id="email_username" type="email" placeholder="Enter Email" class="form-input"  v-model="apiData.settings.email_username"/>
                                                                </div>
                                                                <div>
                                                                    <label for="email_password">Password</label>
                                                                    <input id="email_password" type="Password" placeholder="Enter Password" class="form-input" v-model="apiData.settings.email_password" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <label for="email_from_address">Sender's Email</label>
                                                                <input id="email_from_address" type="email" placeholder="Sender's Email" class="form-input" v-model="apiData.settings.email_from_address" />
                                                            </div>
                                                            <div>
                                                                <label for="email_from_name">Sender Name</label>
                                                                <input id="email_from_name" type="text" placeholder="Sender Name" class="form-input" v-model="apiData.settings.email_from_name"/>
                                                            </div>
                                                            <div>
                                                                <label for="email_subject">Affair</label>
                                                                <input id="email_subject" type="text" placeholder="Affair" class="form-input" v-model="apiData.settings.email_subject" />
                                                            </div>
                                                            <div>
                                                                <label for="email_message">Comment</label>
                                                                <textarea rows="3" wrap="soft" class="form-textarea" x-model="email_message" id="email_message" v-model="apiData.settings.email_message"></textarea>
                                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="space-y-5">
                                                            <div>
                                                                ...
                                                                <input id="whatsapp_token" type="text" placeholder="Sender Name" class="form-input" v-model="apiData.settings.whatsapp_token"/>
                                                            </div>
                                                            <div>
                                                                <label for="whatsapp_sender">WhatsApp Phone</label>
                                                                <input id="whatsapp_sender" type="text" placeholder="WhatsApp Send Number" class="form-input" v-model="apiData.settings.whatsapp_sender"/>
                                                            </div>
                                                            <div>
                                                                <label for="whatsapp_message">Message</label>
                                                                <textarea rows="3" wrap="soft" class="form-textarea" x-model="Message" id="whatsapp_message" v-model="apiData.settings.whatsapp_message"></textarea>
                                                            </div>
                                                            <div>
                                                                <label for="whatsapp_template">WhatsApp Template</label>
                                                                <input id="whatsapp_template" type="text" placeholder="WhatsApp Template" class="form-input" v-model="apiData.settings.whatsapp_template" />
                                                            </div>
                                                            <div>
                                                                <label for="whatsapp_version">WhatsApp API
                                                                    Version</label>
                                                                <input id="whatsapp_version" type="text"
                                                                    placeholder="WhatsApp API Version" class="form-input" v-model="apiData.settings.whatsapp_version"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </vue-collapsible>
                        ...
                        <div class="switch">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                <div class="panel space-y-5">
                                    ...
                                    <p>Remove the active resource from the cache without waiting for the predetermined
                                        cache expiry time.</p>
...
<script lang="ts" setup>
    ...
    const getData = async () => {
        try {
            ...
            const response = await axios.get(`https://apps.ejesatelital.com/api/sass/v1/companies/${route.params.id}`, {
                headers: {
            ...
            if (response.status === 200) {
                ...
                Object.assign(apiData.settings, data.settings);
            } else {
    ...
    const editCompany = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://apps.ejesatelital.com/api/sass/v1/companies/${route.params.id}`,
                jsonData,
                {
                    headers: {
                        'Authorization': `Bearer ${userKey}`,
