                                    ...
                                    <div v-if="!contractData.signature">
                                        <form-wizard color="#4361ee" class="sm-circle" @on-complete="saveContract" step-size="sm"
                                            ...
                                            >
                                                ...
                                                <list-add-documents v-model="documentsList" title="Documentos requeridos de parte del cliente" placeholder="Ejemplo: DNI, Licencia..." ></list-add-documents>
...
<script setup lang="ts">
    ...
    import listAddDocuments from '@/components/partials/listCheckAdd.vue';
    ...
    const documentsList = ref([]); // Estado para almacenar la lista
        ...
        if (data){
            ...
            contractData.value = {
                ...
                options: {
                    ...
                    documents: data.options?.documents||[]
                },
    ...
    const saveContract = async () => {
        loading.value = true;
        contractData.value.options.documents = documentsList.value;
        try {
            if (contractData.value.id) {
