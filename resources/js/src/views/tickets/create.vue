...
const onFilesAdded = (files) => {
    ticketData.value.message.attachments = [...ticketData.value.message.attachments, ...files];
}

const onFileRemoved = (index) => {
    ticketData.value.message.attachments.splice(index, 1);
};
