    ...
    <div>
        ...
        <div class="panel">
            ...
            <div class="p-4 relative">
                <div class="flex flex-wrap">
                    <div class="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                        <img
                            ...
                            alt="avatar"
                        />
                        <div v-show="!selectedTicket.path"
                ...
                <div class="mt-4 prose dark:prose-p:text-white max-w-full prose-img:m-0"
        ...
        <div class="panel" v-if="selectedTicket.status_id != 4">
            <form class="grid gap-4">
                ...
                <div>
                    ...
                    />
                    <div class="mt-8" v-show="ticketResponseData.message.attachments">
                        <div class="h-px border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                        <div class="flex items-center flex-wrap mt-6">
                            <template v-for="(attachment, i) in ticketResponseData.message.attachments" :key="i">
...
const handleFileResponseChange = (event) => {
    ...
    const existingFiles = ticketResponseData.value.message.attachments || []; // Archivos ya almacenados
    ...
    ticketResponseData.value.message.attachments = [...existingFiles, ...newFiles];
};
...
const removeFile = (attachmentToRemove) => {
    ...
    // ).then(isConfirmed => {
    //     if (isConfirmed) {
            ticketResponseData.value.message.attachments = Array.from(ticketResponseData.value.message.attachments).filter(file => file !== attachmentToRemove);
    //     }
    // });
};
