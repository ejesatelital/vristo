                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="ltr:mr-2 rtl:ml-2 flex-1">
                        <div class="flex items-center">
                            ...
                            <div class="text-white-dark whitespace-nowrap"> Creado {{
                                    selectedTicket.created_at_text
                                }}
                            </div>
                        </div>
                                    ...
                                    <template #content="{ close }">
                                        <ul @click="close()" class="whitespace-nowrap">
                                            ...
                                            <li v-if="selectedTicket.user_id == userStore.id">
                                                <a href="javascript:;" class="w-full text-success gap-2"
                                                   @click="setStatus(selectedTicket.id, 4)">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
